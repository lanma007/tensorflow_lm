...
def add_arguments(parser):
  ...
  parser.add_argument("--attention", type=str, default="Lan", help="""\
  ...
  # data
  parser.add_argument("--src", type=float, default=None,
                      help="Source suffix, e.g., en.")
  parser.add_argument("--tgt", type=float, default=None,
  ...
  # Sequence lengths
  parser.add_argument("--src_max_len", type=int, default=20,
                      help="Max length of src sequences during training.")
  parser.add_argument("--tgt_max_len", type=int, default=20,
  ...
  parser.add_argument("--steps_per_stats", type=int, default=200,
